...
def Search_loop():
	...
	if Search_name == '':
		...
		if Search_title[0] in 'abcd':
			url_to_open = 'http://pyramid.areshost6.seedr.io/pyramid/A-D.txt'
		elif Search_title[0] in 'efgh':
			url_to_open = 'http://pyramid.areshost6.seedr.io/pyramid/E-H.txt'
		elif Search_title[0] in 'ijkl':
			url_to_open = 'http://pyramid.areshost6.seedr.io/pyramid/I-L.txt'
		elif Search_title[0] in 'mnop':
			url_to_open = 'http://pyramid.areshost6.seedr.io/pyramid/M-P.txt'
		elif Search_title[0] in 'qrs':
			url_to_open = 'http://pyramid.areshost6.seedr.io/pyramid/Q-S.txt'
		elif Search_title[0] in 't':
			url_to_open = 'http://pyramid.areshost6.seedr.io/pyramid/T.txt'
		elif Search_title[0] in 'uvwxyz':
			url_to_open = 'http://pyramid.areshost6.seedr.io/pyramid/U-Z.txt'
		elif Search_title[0] in '0123456789':
			url_to_open = 'http://pyramid.areshost6.seedr.io/pyramid/0-1000000.txt.txt'
		elif Search_title[0] in '':
			url_to_open = 'http://pyramid.areshost6.seedr.io/pyramid/realdebrid.txt'			
		...
		HTML2 = Open_Url('http://pyramid.areshost6.seedr.io/pyramid/newreleases.txt')
		...
		HTML14 = Open_Url('http://pyramid.areshost6.seedr.io/pyramid/cams.txt')
		...
		for name2,url2,image2,fanart2 in match2:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')					
		HTML3 = Open_Url('http://pyramid.areshost6.seedr.io/pyramid/boxsets.txt')
		...
		HTML13 = Open_Url('http://pyramid.areshost6.seedr.io/pyramid/fullseries.txt')
		...
		for name3,image3,url3,fanart3,info3 in match3:
			...
			if Search_title in name3.lower().replace(' ',''):
				addDir(name3,url3,1,image3,fanart3,info3,'','','')					
		HTML4 = Open_Url('http://pyramid.areshost6.seedr.io/pyramid/realdebrid.txt')
		...
		for name2,url2,image2,fanart2 in match2:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')
		HTML5 = Open_Url('http://pyramid.areshost6.seedr.io/pyramid/specials.txt')
		...
		for name2,url2,image2,fanart2 in match2:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')	
		HTML6 = Open_Url('http://pyramid.areshost6.seedr.io/pyramid/kidsmovies.txt')
		...
		for name2,url2,image2,fanart2 in match2:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')
		HTML7 = Open_Url('http://pyramid.areshost6.seedr.io/pyramid/horror.txt')
		...
		for name2,url2,image2,fanart2 in match2:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')
		HTML8 = Open_Url('http://pyramid.areshost6.seedr.io/pyramid/september.txt')
		...
		for name2,url2,image2,fanart2 in match2:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')
		HTML9 = Open_Url('http://pyramid.areshost6.seedr.io/pyramid/latesttv.txt')
		...
		for name2,url2,image2,fanart2 in match2:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')
		HTML10 = Open_Url('http://pyramid.areshost6.seedr.io/pyramid/july.txt')
		...
		for name2,url2,image2,fanart2 in match2:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')
		HTML11 = Open_Url('http://pyramid.areshost6.seedr.io/pyramid/junetv.txt')
		...
		for name2,url2,image2,fanart2 in match2:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')	
		HTML12 = Open_Url('http://pyramid.areshost6.seedr.io/pyramid/augusttv.txt')
		...
		for name2,url2,image2,fanart2 in match2:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')	
		HTML17 = Open_Url('http://pyramid.areshost6.seedr.io/pyramid/documentaries.txt')
